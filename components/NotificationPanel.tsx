...
export default function NotificationPanel(props: NotificationPanelProps) {
  const ContentComponent = props.isMobile ? MobileContent : DesktopContent;
  return (
    <AnimatePresence>
      <ContentComponent
        notifications={props.notifications}
        markingReadIds={props.markingReadIds}
        onMarkAsRead={props.onMarkAsRead}
        onMarkAllAsRead={props.onMarkAllAsRead}
        isMarkingAll={props.isMarkingAll}
        getTimeAgo={props.getTimeAgo}
        onClose={props.onClose}
        anchor={props.isMobile ? undefined : props.anchor}
      />
    </AnimatePresence>
  );
}
