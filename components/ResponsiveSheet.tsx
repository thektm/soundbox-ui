  ...
  return (
    <Drawer.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 sb-native-bottom-safe left-0 right-0 max-h-[95vh] bg-gradient-to-t from-[#0a0a0a] to-[#1a1a1a] rounded-t-3xl border-t border-white/10 z-[80] flex flex-col outline-none">
